 ...
 */
function handleMessage(ws: WebSocket, message: ServerMessage): void {
    try {
 ...
 */
function createRoom(ws: WebSocket, message: CreateRoomRequest): void {
 ...
 */
function joinRoom(ws: WebSocket, message: JoinRoomRequest): void {
 ...
 */
function relayMessage(message: OfferMessage | AnswerMessage | IceCandidateMessage): void {
 ...
 */
function assignNewHost(roomId: any, participants: Set<string>) {
 ...
 */
function notifyPeers(roomId: string, excludeUsername: string, message: ServerResponse): void {
    const room = rooms.get(roomId);
